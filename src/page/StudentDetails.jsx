...
const StudentDetails = (props) => {
  ...
  return (
    <Box className={classes.root}>
          ...
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.contactInformation?.campusEmail || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Campus Mail:</span>
              <span className={classes.value}>
                {student.contactInformation?.campusMail || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Preferred Email:</span>
              <span className={classes.value}>
                {student.contactInformation?.preferredEmail || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Primary Phone:</span>
              <span className={classes.value}>
                {student.contactInformation?.primaryPhone || "-"}
              </span>
            </div>
          </Grid>
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.contactInformation?.cellularPhone || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Emergency Contact Name:</span>
              <span className={classes.value}>
                {student.contactInformation?.emergencyContactName || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.contactInformation?.emergencyContactRelationship ||
                  "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Emergency Contact Phone:</span>
              <span className={classes.value}>
                {student.contactInformation?.emergencyContactPhoneNumber || "-"}
              </span>
            </div>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.housingInformation?.residenceTerm || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Building:</span>
              <span className={classes.value}>
                {student.housingInformation?.building || "-"}
              </span>
            </div>
          </Grid>
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.housingInformation?.roomNo || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Phone:</span>
              <span className={classes.value}>
                {student.housingInformation?.phone || "-"}
              </span>
            </div>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.gradeInformation?.lifestyle || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Major:</span>
              <span className={classes.value}>
                {student.gradeInformation?.major || "-"}
              </span>
            </div>
            ...
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.gradeInformation?.gradDate || "-"}
              </span>
            </div>
          </Grid>
          <Grid item xs={12} md={6}>
            <div className={classes.infoRow}>
              ...
              <span className={classes.value}>
                {student.gradeInformation?.arrivalDate || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>ENRL:</span>
              <span className={classes.value}>
                {student.gradeInformation?.enrl || "-"}
              </span>
            </div>
            <div className={classes.infoRow}>
              <span className={classes.label}>Academic Advisor:</span>
              <span className={classes.value}>
                {student.gradeInformation?.academicAdvisor || "-"}
              </span>
            </div>
          </Grid>
        </Grid>
      ...
      {/* ferpa Release Designees Information */}
      <Box className={classes.section}>
        <Typography variant="h3">
          FERPA Academic Information Release Designees
        </Typography>
        {student.ferpaReleaseDesignees.map((el, index) => {
          return (
            <Grid key={`ferpa-item-${index}`} container spacing={2}>
              <Grid item xs={12} md={6}>
                <div className={classes.infoRow}>
              ...
              <Grid key={`ferpa-item-${index}`} item xs={12} md={6}>
                <div className={classes.infoRow}>
